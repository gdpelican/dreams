...
class Api::CampsController < ApplicationController
  ...
  def index
    ...
    # 'fields' slots in the hash, which will allow the client to have pretty granular
    # control over what data they receive back from the API.
  ...
  def create
    ...
    #   render jsonapi: @camp
    # else
    #   render json: { errors: @camp.errors }
    # end
  end

  private

  # This isn't a super flexible method, but it's a quick way to get a little
